...
from hdr_forge.ffmpeg.video_codec.service.presets import Hdr_Forge_HEVC_NVENC_Preset
...
class HevcNvencCodec(VideoCodecBase):
    ...
    def __init__(self, encoder_settings: EncoderSettings, video: Video, scale: Tuple[int, int]):
        ...
        hw_preset: Hdr_Forge_HEVC_NVENC_Preset = self.calc_hw_preset_settings(Hdr_Forge_HEVC_NVENC_Preset)
    ...
    def _get_auto_preset(self, hw_preset: Hdr_Forge_HEVC_NVENC_Preset) -> HEVC_NVENC_Preset:
    ...
    def _get_auto_cq(self, hw_preset: Hdr_Forge_HEVC_NVENC_Preset) -> int:
