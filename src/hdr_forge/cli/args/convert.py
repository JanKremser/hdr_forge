...
Dolby Vision notes:
- Encoding to profiles 7 and 5 is not supported. Convert to profile 8.1 (dv8) or use copy mode (auto).
...
- HDR10Plus metadata is passed through from the input video if available, but not edited or generated by HDR Forge.\n
"""
    )
